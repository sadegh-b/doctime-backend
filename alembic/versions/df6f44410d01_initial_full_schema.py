...
def upgrade() -> None:
    ...
    sa.Column('medical_council_number', sa.String(length=50), nullable=False),
    sa.Column('specialty', sa.String(length=120), nullable=False),
    sa.Column('sub_specialty', sa.String(length=120), nullable=True),
    sa.Column('work_shift', sa.String(length=20), nullable=False),
    ...
    sa.Column('waiting_time_estimate', sa.String(length=100), nullable=False),
    ...
    with op.batch_alter_table('doctors', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_doctors_medical_council_number'), ['medical_council_number'], unique=True)
...
def downgrade() -> None:
    ...
    with op.batch_alter_table('doctors', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_doctors_medical_council_number'))
